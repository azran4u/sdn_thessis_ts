...
function start() {
    return __awaiter(this, void 0, void 0, function* () {
        const db1 = database_1.DatabaseConnector.getInstance({
        ...
        const date1 = yield db1.getCurrentTime();
        console.log(`date1=${date1}`);
        const db2 = database_1.DatabaseConnector.getInstance();
        const date2 = yield db2.getCurrentTime();
        console.log(`date2=${date2}`);
        yield db1.disconnect();
    });
}
